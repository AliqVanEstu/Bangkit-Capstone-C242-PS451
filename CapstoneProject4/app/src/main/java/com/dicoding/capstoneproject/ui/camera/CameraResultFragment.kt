...
class CameraResultFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Mendapatkan Bitmap dari argumen
        ...
        retryButton.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_navigation_camera_result_to_navigation_camera)
        }
    }

    private fun performMachineLearningAnalysis(bitmap: Bitmap): String {
        // Implementasikan logika untuk analisis ML di sini
        // Kembalikan hasil analisis sebagai String
        return "Hasil terjemahan dari gambar: "
    }
